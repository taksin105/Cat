    ...
    <div class="row">
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<a href='edit_cat.php?id=" . $row['id'] . "' class='btn btn-primary btn-sm'>แก้ไข (Edit)</a> ";
                echo "<a href='delete_cat.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm'>ลบ (Delete)</a>";
                echo "</div>";
                echo "</div>";
            }
        } else {
